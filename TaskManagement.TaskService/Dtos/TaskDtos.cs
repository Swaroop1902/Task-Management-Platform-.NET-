...
{
    public record CreateTaskRequest(string Title, string? Description, string Priority, string Status, int? AssigneeId, DateTime? DueDate);
    public record UpdateTaskRequest(string? Title, string? Description, string? Priority, string? Status, int? AssigneeId, DateTime? DueDate);
